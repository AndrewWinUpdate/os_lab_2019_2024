...
//etext указывает на конец сегмента кода в памяти. Он содержит машинные инструкции, которые выполняет этот процесс

//edata указывает на конец сегмента инициализированных данных. Он содержит глобальные и статические переменные, которые были инициализированы

//end указывает на конец сегмета данных. Включает в себя неициализированные глобальные и статические переменные. Они занимают память, но все еще не определены